...
function sourceState(){
  ...
  return [
    ...
    {key:'fleury',name:'Fleury',status:sourceStatus(fleury,['labs','uploads']),capability:'CSV estruturado + documento preservado',readyDetail:'Há exames ou arquivo do Fleury.',missingDetail:'Envie CSV, PDF ou imagem do exame.',action:'Enviar Fleury',scope:'CSV reconhecido pode estruturar resultados. Resultado textual permanece textual; linha ambígua fica para revisão. PDF e imagem ficam preservados como documentos e não criam resultados até existir leitura especializada validada.'},
    {key:'einstein',name:'Einstein',status:sourceStatus(einstein,['labs','uploads']),capability:'CSV estruturado + documento preservado',readyDetail:'Há exames ou arquivo do Einstein.',missingDetail:'Envie CSV, PDF ou imagem do exame.',action:'Enviar Einstein',scope:'CSV reconhecido pode estruturar resultados. Resultado textual permanece textual; linha ambígua fica para revisão. PDF e imagem ficam preservados como documentos e não criam resultados até existir leitura especializada validada.'}
  ];
}
