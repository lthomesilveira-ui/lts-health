...
function sourceState(){
  ...
  return [
    ...
    {key:'fleury',name:'Fleury',status:sourceStatus(fleury,['labs','uploads']),capability:'Documento preservado',readyDetail:'Há resultados ou documentos identificados como Fleury.',missingDetail:'Envie os PDFs dos exames para organizar resultados por coleta.',action:'Enviar exame do Fleury',scope:'PDFs e imagens ficam preservados; resultados estruturados só entram após extração validada.'},
    {key:'einstein',name:'Einstein',status:sourceStatus(einstein,['labs','uploads']),capability:'Documento preservado',readyDetail:'Há resultados ou documentos identificados como Einstein.',missingDetail:'Envie os PDFs dos exames para adicionar essa fonte ao histórico.',action:'Enviar exame do Einstein',scope:'PDFs e imagens ficam preservados; resultados estruturados só entram após extração validada.'}
  ];
}
