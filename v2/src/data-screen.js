...
function sourceState(){
  return [
    {key:'apple_health',name:'Apple Saúde',status:sourceStatusFor('apple_health'),capability:'Leitura automática parcial',readyDetail:'Dados compatíveis do Apple Saúde encontrados.',missingDetail:'Envie o export do app Saúde.',action:'Enviar Apple Saúde',scope:'A leitura automática validada inclui energia ativa, minutos de exercício, horas em pé e duração do sono. Passos e FC de repouso não são importados automaticamente por este fluxo; só aparecem quando já existem como registros válidos de outra origem.'},
    {key:'polar_flow',name:'Polar Flow',status:sourceStatusFor('polar_flow'),capability:'Arquivo + revisão',readyDetail:'Dados do Polar encontrados.',missingDetail:'Envie um export do Polar Flow.',action:'Enviar Polar',scope:'O arquivo pode complementar detalhes de treino. O mesmo treino não é contado duas vezes quando outra fonte já o representa.'},
    {key:'myfitnesspal',name:'MyFitnessPal',status:sourceStatusFor('myfitnesspal'),capability:'Leitura automática de nutrição',readyDetail:'Dados estruturados do MyFitnessPal encontrados.',missingDetail:'Envie o export do MyFitnessPal.',action:'Enviar MyFitnessPal',scope:'CSV reconhecido consolida calorias e macros por dia. Campo ausente continua ausente. Atividade do MyFitnessPal permanece separada de treinos estruturados.'},
