...
function sourceState(){
  ...
  return [
    {key:'apple_health',name:'Apple Saúde',status:sourceStatus(apple,['uploads','metrics']),capability:'Leitura automática parcial',readyDetail:'Dados do Apple Saúde encontrados.',missingDetail:'Envie o export do app Saúde.',action:'Enviar Apple Saúde',scope:'Energia ativa, minutos de exercício, horas em pé e sono entram automaticamente quando a leitura é segura. Passos e FC de repouso só entram em dias sem conflito de fontes.'},
    ...
    {key:'fleury',name:'Fleury',status:sourceStatus(fleury,['labs','uploads']),capability:'CSV estruturado + documento preservado',readyDetail:'Há exames ou arquivo do Fleury.',missingDetail:'Envie CSV, PDF ou imagem do exame.',action:'Enviar Fleury',scope:'CSV reconhecido pode estruturar resultados. Resultado textual permanece textual; linha ambígua fica para revisão. PDF e imagem ficam preservados até existir leitura especializada validada.'},
    {key:'einstein',name:'Einstein',status:sourceStatus(einstein,['labs','uploads']),capability:'CSV estruturado + documento preservado',readyDetail:'Há exames ou arquivo do Einstein.',missingDetail:'Envie CSV, PDF ou imagem do exame.',action:'Enviar Einstein',scope:'CSV reconhecido pode estruturar resultados. Resultado textual permanece textual; linha ambígua fica para revisão. PDF e imagem ficam preservados até existir leitura especializada validada.'}
  ];
}
