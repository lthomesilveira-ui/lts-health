...
function recentEvents(model){
  ...
  if(model.labs.last)events.push({date:model.labs.last,route:'saude',domain:'Exames',title:'Coleta laboratorial',detail:`${model.labs.totalResults} resultado(s) estruturado(s)`});
