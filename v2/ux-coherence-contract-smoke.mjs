...
assert.match(index,/lts-build" content="home-dashboard-reference-20260915\.30/);
assert.match(index,/ux-coherence\.css\?v=home-dashboard-reference-20260915\.30/);
assert.match(index,/main\.js\?v=home-dashboard-reference-20260915\.30/);
