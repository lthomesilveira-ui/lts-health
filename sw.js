const CACHE='lts-health-shell-v13';
const SHELL=['./','./index.html','./styles.css','./v10.css','./v11.css','./v12.css','./v13.css','./config.js','./app.js','./app-v8.js','./app-v11.js','./app-v12.js','./app-v13.js','./manifest.webmanifest'];
